<!-- moved out of README.md on 2026-09-13; the workstation runs Ubuntu + Determinate Nix today and only the labs are in daily use -->
# Legacy NixOS configuration (repo root)
